...
class CallCenterTranscriptionTaskController extends Controller
{
    use TerminatesTrackedProcess;

    public function store(CallCenterTranscriptionTaskStore $taskStore): JsonResponse
    {
    ...
    public function destroy(string $taskId, CallCenterTranscriptionTaskStore $taskStore): JsonResponse
    {
