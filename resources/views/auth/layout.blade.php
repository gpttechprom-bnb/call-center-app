...
<div class="auth-shell">
    <aside class="auth-brand">
        ...
        <h2 class="brand-title">Call Center QA</h2>
        <p class="brand-text">Єдиний робочий простір для аналізу дзвінків, оцінювання менеджерів та керування чек-листами.</p>
        <ul class="brand-points">
            <li>Транскрибація та оцінювання дзвінків</li>
            <li>Зведення по менеджерах і рекомендації</li>
            <li>Гнучкі налаштування моделей та API</li>
        </ul>
    </aside>
